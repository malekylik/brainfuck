...
// pure loop
if (__m__[p + 0]) {
    __m__[p + 1] += 2 * __m__[p + 0];
    __m__[p + 4] += 5 * __m__[p + 0];
    __m__[p + 5] += 2 * __m__[p + 0];
    __m__[p + 6] += __m__[p + 0];
    // set to zero loop
    __m__[p + 0] = 0;
}
...
while (__m__[p + 28]) {
    ...
    while (__m__[p + 19]) {
        ...
        while (__m__[p + 25]) {
            ...
            __m__[p + 25] += 1;
            __m__[p + 26] = __m__[p + 27] = __m__[p + 28] = __m__[p + 29] = __m__[p + 30] = __m__[p + 31] = __m__[p + 32] = __m__[p + 33] = __m__[p + 34] = 0;
            while (__m__[p + 25]) {
                p += -9;
            }
            __m__[p + 34] -= 1;
        ...
        while (__m__[p + 45]) {
            ...
            while (__m__[p + 51]) {
                __m__[p + 53] = __m__[p + 54] = __m__[p + 55] = 0;
                p += 9;
            }
            while (__m__[p + 42]) {
                p += -9;
            ...
            while (__m__[p + 51]) {
                ...
                __m__[p + 51] += 1;
                __m__[p + 52] = __m__[p + 53] = __m__[p + 54] = __m__[p + 55] = __m__[p + 56] = __m__[p + 57] = __m__[p + 58] = __m__[p + 59] = __m__[p + 60] = 0;
                while (__m__[p + 51]) {
                    p += -9;
                }
                __m__[p + 60] -= 1;
            ...
            // set to zero loop
            __m__[p + 43] = 0;
            __m__[p + 45] = __m__[p + 46] = 0;
            while (__m__[p + 51]) {
                __m__[p + 53] = __m__[p + 54] = 0;
                p += 9;
            }
            while (__m__[p + 42]) {
                p += -9;
            ...
            while (__m__[p + 51]) {
                __m__[p + 54] = __m__[p + 55] = __m__[p + 56] = 0;
                p += 9;
            }
            while (__m__[p + 42]) {
                p += -9;
        ...
        __m__[p + 44] = __m__[p + 45] = __m__[p + 46] = __m__[p + 47] = __m__[p + 48] = __m__[p + 49] = 0;
        while (__m__[p + 52]) {
            __m__[p + 53] = __m__[p + 54] = __m__[p + 55] = __m__[p + 56] = __m__[p + 57] = __m__[p + 58] = 0;
            p += 9;
        }
        while (__m__[p + 43]) {
            p += -9;
