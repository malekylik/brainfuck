...
import { mandelbrot_answer, yapi_answer, hellom_answer, beer_answer, char_answer } from '../data/bf_answers';
import { mandelbrot_src, yapi_src, hellom_src, beer_src, char_src } from '../data/bf_programs';
